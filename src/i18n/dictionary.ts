...
const en = {
  ...
  "menu.menu": "Menu",
  "menu.covers": "people",
  "dash.free": "Tables free",
  "dash.waiting": "Waiting",
  "dash.calling": "Now calling",
  "dash.nobodyCalled": "Nobody called right now.",
  "dash.coversToday": "Seated today",
  "dash.revenueToday": "Takings today",
  "dash.openBills": "Open bills",
  "dash.avgWait": "Average wait",
  "dash.longest": "longest",
  "dash.topDishes": "Selling today",
...
const th: Partial<Record<MessageKey, string>> = {
  ...
  "dash.free": "โต๊ะว่าง",
  "dash.waiting": "รอคิว",
  "dash.calling": "กำลังเรียก",
  "dash.nobodyCalled": "ยังไม่มีคิวที่กำลังเรียก",
  "dash.coversToday": "รับแล้ววันนี้",
  "dash.revenueToday": "ยอดขายวันนี้",
  "dash.openBills": "บิลที่เปิดอยู่",
  "dash.avgWait": "รอเฉลี่ย",
  "dash.longest": "นานสุด",
  "dash.topDishes": "ขายดีวันนี้",
  "dash.noShows": "ไม่มาตามคิว",
  "dash.covers": "ท่าน",
  "dash.parties": "กลุ่ม",
...
const zh: Partial<Record<MessageKey, string>> = {
  ...
  "dash.waiting": "等待中",
  "dash.calling": "正在叫号",
  "dash.nobodyCalled": "目前没有叫号",
  "dash.coversToday": "今日接待",
  "dash.revenueToday": "今日营业额",
  "dash.openBills": "未结账单",
  "dash.avgWait": "平均等待",
  "dash.longest": "最长",
  "dash.topDishes": "今日热卖",
